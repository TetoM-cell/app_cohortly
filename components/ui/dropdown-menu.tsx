  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-lg border border-gray-300 shadow-md",
          className
        )}
        {...props}
      >
        <ScalingWrapper className="h-full w-full p-1 max-h-(--radix-dropdown-menu-content-available-height) overflow-y-auto">
          {props.children}
        </ScalingWrapper>
      </DropdownMenuPrimitive.Content>
    </DropdownMenuPrimitive.Portal>
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "bg-popover text-popover-foreground z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-lg border border-gray-300 shadow-lg",
        className
      )}
      {...props}
    >
      <ScalingWrapper className="h-full w-full p-1">
        {props.children}
      </ScalingWrapper>
    </DropdownMenuPrimitive.SubContent>
  )
