...
create index if not exists idx_app_prog_submitted on public.applications (program_id, submitted_at desc);
create index if not exists idx_app_prog_email_submitted on public.applications (program_id, applicant_email, submitted_at desc);
create index if not exists idx_comments_application_created on public.comments (application_id, created_at desc);
